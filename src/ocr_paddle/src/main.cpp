...
int main(int argc, char **argv) {
  FLAGS_det_model_dir="D:\\code\\target_position\\ch_PP-OCRv4_det_infer";

  FLAGS_rec_model_dir="D:\\code\\target_position\\ch_PP-OCRv4_rec_infer";
   FLAGS_image_dir="D:\\code\\target_position\\image";
